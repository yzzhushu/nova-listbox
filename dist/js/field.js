...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    loadLists: function loadLists() {
      ...
      return;
      Nova.request().get(this.field.options).then(function (response) {
        _this.handleLists(response.data.resources);
      });
    },
    // 筛选有效数据
    handleLists: function handleLists(lists) {
      var list = [];
      var pick = this.field.value;
      lists.map(function (item) {
        var code = item.value || item.id;
        if (pick.includes(code)) list.push(item);
      });
      this.formatLists(list);
    },
    // 格式化数据
    formatLists: function formatLists(lists) {
      if (lists.length === 0) {
        this.lists = [{
          code: 0,
          name: '暂无数据'
      ...
      var _mix = this.field.nameWithCode || false;
      var list = [];
      lists.map(function (item) {
        var code = item.value || item.id;
        var name = item.display || item.name;
        list.push({
          code: code,
          name: (_mix ? code + ' - ' : '') + name
        });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    // 删除选中
    delColumn: function delColumn() {
      if (this.selected1 === null || this.selected1 === undefined) return;
      delete this.check[this.selected1];
      this.drawLists();
    },
    // 选中
    addColumn: function addColumn() {
      if (this.selected2 === null || this.selected2 === undefined) return;
      this.check[this.selected2] = true;
      this.drawLists();
    },
    // 查询全部列表数据
    _loadLists: function _loadLists(request_url) {
      var _this = this;
      Nova.request().get(request_url).then(function (response) {
        _this.handleData(response.data.resources);
      });
    },
    // 处理选择清单
    handleData: function handleData(lists) {
      var _mix = this.field.nameWithCode;
    ...
    // 绘制lists
    drawLists: function drawLists() {
      var _this2 = this;
      var list1 = [];
      var list2 = [];
      this.lists.map(function (item) {
        if (_this2.check[item.code] === undefined) list2.push(item);else list1.push(item);
      });
      this.list1 = list1;
      this.list2 = list2;
    },
...
var _hoisted_2 = {
  "class": "appearance-none inline-flex items-center text-left rounded-lg !cursor-default"
};
var _hoisted_3 = {
  "class": "inline-flex items-center whitespace-nowrap min-h-6 px-2 rounded-full uppercase text-xs font-bold bg-primary-50 dark:bg-primary-500 text-primary-600 dark:text-gray-900 space-x-1"
};
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_PanelItem, {
    ...
    value: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.lists, function (item) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.name), 1 /* TEXT */)])]);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  var _component_SplitterPanel = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("SplitterPanel");
  var _component_Splitter = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("Splitter");
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Splitter, {
        style: {
          "height": "calc(260px + 40px + 1.25rem)"
        }
      }, {
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_SplitterPanel, null, {
            "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
              return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Listbox, {
                modelValue: $data.selected1,
                "onUpdate:modelValue": _cache[0] || (_cache[0] = function ($event) {
                  return $data.selected1 = $event;
                }),
                options: $data.list1,
                optionLabel: "name",
                optionValue: "code",
                ...
                emptyMessage: $props.field.messages.emptyMessage,
                filterPlaceholder: $props.field.messages.filterPlaceholder,
                emptyFilterMessage: $props.field.messages.emptyFilterMessage,
                listStyle: "height:260px",
                onChange: $options.delColumn
              }, null, 8 /* PROPS */, ["modelValue", "options", "emptyMessage", "filterPlaceholder", "emptyFilterMessage", "onChange"])];
            }),
            _: 1 /* STABLE */
          }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_SplitterPanel, null, {
            "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
              return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Listbox, {
                modelValue: $data.selected2,
                "onUpdate:modelValue": _cache[1] || (_cache[1] = function ($event) {
                  return $data.selected2 = $event;
                }),
                options: $data.list2,
                optionLabel: "name",
                optionValue: "code",
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    ...
    menu: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_DropdownMenu, {
        ...
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("ul", _hoisted_2, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.lists, function (item) {
            return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", _hoisted_3, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.name), 1 /* TEXT */);
          }), 256 /* UNKEYED_FRAGMENT */))])];
        }),
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_DropdownTrigger, {
        ...
        showArrow: false,
        onClick: $options.loadLists
      }, {
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_1, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.display), 1 /* TEXT */)];
        }),
    ...
    _: 1 /* STABLE */
  })) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_4, "—"))], 2 /* CLASS */);
}
...
Nova.booting(function (app, store) {
  app.component('index-list-box', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-list-box', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-list-box', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
/* harmony import */ var _Users_zhushu_ERP_field_nova_components_ListBox_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_Users_zhushu_ERP_field_nova_components_ListBox_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/* harmony import */ var _Users_zhushu_ERP_field_nova_components_ListBox_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
const __exports__ = /*#__PURE__*/(0,_Users_zhushu_ERP_field_nova_components_ListBox_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__["default"])(_FormField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_FormField_vue_vue_type_template_id_c023248a__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/FormField.vue"]])
/* hot reload */
if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkjshxl_list_box"] = self["webpackChunkjshxl_list_box"] || [];
